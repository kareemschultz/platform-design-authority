...
| MCP | Defer | Governed Developer Platform MCP or OAuth Provider successor design | Official documentation indicates succession toward OAuth Provider. Authentication is only one layer. Tool discovery and execution still require canonical application commands, permissions, entitlements, approvals, tenant scope, audit, and AI safety policy. |
