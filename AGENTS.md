...
- `01-Platform/BETTER_AUTH_PLUGIN_AND_FEATURE_DECISION_MATRIX.md` before enabling or recommending Better Auth functionality
- `09-UX/SHADCN_CONFIGURATION_DECISION_MATRIX.md` before changing the governed UI configuration
- `02-Architecture/BUN_HONO_ORPC_DECISION_MATRIX.md` before changing runtime, HTTP shell, transport, or fallback policy
- `02-Architecture/WORKFLOW_RUNTIME_DECISION_MATRIX.md` before changing workflow infrastructure
- `02-Architecture/DOCUMENTATION_PLATFORM_DECISION_MATRIX.md` before changing documentation delivery
