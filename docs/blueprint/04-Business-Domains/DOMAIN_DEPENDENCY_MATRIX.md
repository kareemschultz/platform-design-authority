...
related_adrs: [ADR-0003, ADR-0007, ADR-0009, ADR-0010, ADR-0012, ADR-0013, ADR-0014, ADR-0015, ADR-0027]
---
...
- Platform Import/Export writing a domain's tables or importing its repository/migrations; it orchestrates published owner commands and retains only staging, checkpoint, reconciliation, and receipt evidence. Its human import reference is allocated through Platform Numbering, never inferred or generated by Catalog/Inventory.
