...
- **Detailed plan:** `WS3_POS_CASH_IMPLEMENTATION_PLAN.md` (PDA-RDM-012) — FROZEN permission/event/capability tables, maker/checker state machines, package ownership, lane-command table, and evidence matrix for the controlled-prototype PR1-PR6 sequence on `claude/ws3-integration`. This entry stays the authoritative summary; PDA-RDM-012 does not override it.
...
- 2026-07-18 — v0.17.1 linked the WS3 detailed plan `WS3_POS_CASH_IMPLEMENTATION_PLAN.md` (PDA-RDM-012), created by WS3 PR0 under the FDR-012 controlled-prototype exception; this entry remains the authoritative summary.
