...
| Operations readiness | no deployable service/agent/collector/provider exists to exercise backup, compatibility, stale-source, kill or restore behavior | add service-specific readiness only after deployment selection; do not claim PDA-OPS-018 covers it | access limitations | High | before pilot | Operations, Security, provider owner |
...
PDA-FND-002, ADR-0002, ADR-0003, ADR-0014, ADR-0019, PDA-DOM-013, PDA-DOM-014, PDA-DOM-021, PDA-PLT-005, PDA-SEC-001, PDA-DEV-003, PDA-OPS-018, PDA-UX-011, PDA-CIR-093, PDA-CIR-094, `registry/capabilities.json`, `registry/events.json`, `registry/permissions.json`, `registry/architecture-rules.json`, and `registry/first-slice.json`.
