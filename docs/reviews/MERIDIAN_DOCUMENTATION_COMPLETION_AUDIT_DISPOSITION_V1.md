...
| DCA-004 | Critical | Accepted | Implemented; `062b045` is the latest fully green evidence checkpoint and every later head requires the same checks | Generated document registry current; PR #75 documentation jobs green in a fresh checkout |
