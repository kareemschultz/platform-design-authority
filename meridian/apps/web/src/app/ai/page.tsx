...
import { Bubble, BubbleContent } from "@meridian/ui/components/bubble";
...
import {
  ...
  EmptyMedia,
  EmptyTitle,
} from "@meridian/ui/components/empty";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from "@meridian/ui/components/input-group";
import {
  Message,
  MessageContent as MessageBody,
  MessageHeader,
} from "@meridian/ui/components/message";
import {
  MessageScroller,
...
} from "@meridian/ui/components/message-scroller";
import { Tooltip, TooltipContent, TooltipTrigger } from "@meridian/ui/components/tooltip";
          ...
          {messages.length === 0 && !isSending ? (
            <Empty className="mx-auto h-full max-w-3xl px-4">
              <EmptyHeader>
                ...
                <EmptyTitle>Morning, meridian!</EmptyTitle>
