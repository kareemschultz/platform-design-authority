...
import { cn } from "@meridian/ui/lib/utils";
import type * as React from "react";

function Label({ className, ...props }: React.ComponentProps<"label">) {
	return (
		// biome-ignore lint/a11y/noLabelWithoutControl: This source-owned shadcn primitive is associated by consumers through htmlFor or nesting.
		<label
			className={cn(
