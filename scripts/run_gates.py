...
def build_gates() -> list[Gate]:
    ...
    for script in (
        ...
        "check_document_id_collisions.py",
        "validate_ui_governance.py",
    ...
    for script in (
        ...
        "test_check_document_id_collisions.py",
        "test_validate_ui_governance.py",
